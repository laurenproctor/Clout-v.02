...
const bodySchema = z.object({
  variation: z.object({
    ...
    resolvedFormat:   z.string().nullable().optional(),
  ...
  const { data, error } = await supabase
    ...
    .insert({
      ...
      content: {
        ...
        visualPlan:     variation.visualPlan ?? null,
        intelligence:   variation.intelligence ?? null,
        campaignName:   variation.campaignName ?? null,
        resolvedFormat: variation.resolvedFormat ?? null,
        resolvedStyle:  variation.resolvedStyle ?? null,
