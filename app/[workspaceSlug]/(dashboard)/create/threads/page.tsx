// app/[workspaceSlug]/(dashboard)/create/threads/page.tsx
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="border-b border-zinc-100 px-8 py-4">
        <h1 className="font-[Signifier] text-lg font-semibold text-zinc-900">Threads Post</h1>
        <p className="text-xs text-zinc-400 mt-0.5">
          Authentic engagement — real conversations, genuine audience connection.
        </p>
      </div>
